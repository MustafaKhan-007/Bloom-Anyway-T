...
def create_app(config_class=None):
    ...
    # --- PRELAUNCH LOCK (TEMPORARILY DISABLED) --------------------------------
    # Site is open. To re-enable the under-construction gate, uncomment this
    # block (and set PRELAUNCH_LOCK=1 in production if needed).
    # Also keep Studio → Prelaunch for the allowlist when you turn it back on.
    #
    # @app.before_request
    # def _prelaunch_gate():
